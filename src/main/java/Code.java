...
public class Code {
    ...
    static String comp(String code) {
        ...
        if (code.equals("D+1"))     return "0011111";
        if (code.equals("A+1"))     return "0110111";
        if (code.equals("M+1"))     return "1110111";
        if (code.equals("D-1"))     return "0001110";
        if (code.equals("A-1"))     return "0110010";
        if (code.equals("M-1"))     return "1110010";
        if (code.equals("D+A"))     return "0000010";
        if (code.equals("D+M"))     return "1000010";
        ...
        if (code.equals("D&A"))     return "0000000";
        if (code.equals("D&M"))     return "1000000";
        if (code.equals("D|A"))     return "0010101";
        if (code.equals("D|M"))     return "1010101";
